...
import FavoriteProduct from "./src/FavoriteProduct.tsx";
...
const FavoriteModal: FC<Props> = (props) => {
    const {open, onClose,} = props;
    const favorite = useFavorite();

    const filters = useMemo(
        () => ({ids: favorite.favoriteIds}),
    ...
    return (
        <Overlay open={open}>
            <Modal>
                <Header>
                    <HeaderLeft>
                        ...
                        <HeaderInfo>
                            ...
                            <Description>
                                {favorite.favorite.length} товарів в улюблених
                            </Description>
                        </HeaderInfo>
                    </HeaderLeft>
                ...
                <Content>
                    <Products>
                        {favorite.favorite.length > 0 && list.map(product => (
